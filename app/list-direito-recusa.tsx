                ...
                <ScrollView className="flex-1 bg-slate-100 px-4">
                        ...
                        <View className="p-4 mt-4">
                            <View className="space-y-3">
                                ...
                                {rightRefusals.map((item, index) => (
                                    <Pressable key={item.uuid || `${index}-${item.usuario_nome}`}
                    ...
                    {rightRefusals.length == 0 &&
                        <View className="flex flex-col justify-center items-center mt-10">
                            ...
                            <Text className="text-slate-500 mt-2 text-sm">Toque em "Novo formulário" para preencher um direito de recusa.</Text>
                        </View>
                    }
                </ScrollView>
            </SafeAreaView>
